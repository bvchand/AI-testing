...
public class Wysa_TC1_7 {
	static void tc7(DesiredCapabilities dc, AndroidDriver<AndroidElement> driver, WebDriverWait wait) throws IOException {
...
MobileElement el1 = (MobileElement) driver.findElementByAccessibilityId("Wysa");
        ...
        FileUtils.writeByteArrayToFile(new File("appiumRecorded1.mp4"), decode);
