...
public class Wysa_TC1_6 {
	static void tc6(DesiredCapabilities dc, AndroidDriver<AndroidElement> driver, WebDriverWait wait) throws IOException {
...
MobileElement el1 = (MobileElement) driver.findElementByAccessibilityId("Wysa");
		...
		el7.sendKeys("Measure Myself as Stress");
		...
		el8a.sendKeys("Measure myself as stress");
