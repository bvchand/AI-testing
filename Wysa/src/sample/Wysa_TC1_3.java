...
public class Wysa_TC1_3 {
	static void tc3(DesiredCapabilities dc, AndroidDriver<AndroidElement> driver, WebDriverWait wait) throws IOException {
...
//(MobileElement) //driver.findElementByXPath("//android.widget.RelativeLayout[@content-desc=\"Urge //Surfing\"]");
		...
		el7.sendKeys("I###am???feeling88anxious");
		...
		FileUtils.copyFile(scrFile2, new File("1.3." + "4" + ".jpg"));
		System.out.println("Screenshot taken and saved to folder.");
		String video = driver.stopRecordingScreen();

        byte[] decode = Base64.getDecoder().decode(video);

        FileUtils.writeByteArrayToFile(new File("1.3Testcase.mp4"), decode);
