...
public class Wysa_TC1_9 {
	static void tc9(DesiredCapabilities dc, AndroidDriver<AndroidElement> driver, WebDriverWait wait) throws IOException {
		...
		el7.sendKeys("Why am I scared of COVID?");
...
//		driver.manage().timeouts().implicitlyWait(10, TimeUnit.SECONDS);
		...
		FileUtils.writeByteArrayToFile(new File("1.9 Test.mp4"), decode);
