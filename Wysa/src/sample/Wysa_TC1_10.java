...
public class Wysa_TC1_10 {
	static void tc10(DesiredCapabilities dc, AndroidDriver<AndroidElement> driver, WebDriverWait wait) throws IOException {
		...
		el7.sendKeys("COVID why I am scared");
...
//		driver.manage().timeouts().implicitlyWait(10, TimeUnit.SECONDS);
		...
		FileUtils.writeByteArrayToFile(new File("1.10 Test.mp4"), decode);
