...
public class Wysa_TC2_1 {
	static void tc13(DesiredCapabilities dc, AndroidDriver<AndroidElement> driver, WebDriverWait wait) throws IOException {
...
MobileElement el1 = (MobileElement) driver.findElementByAccessibilityId("Wysa");
		...
		FileUtils.writeByteArrayToFile(new File("2.1 Test.mp4"), decode);
