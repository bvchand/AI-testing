...
public class Wysa_TC1_12 {
	static void tc12(DesiredCapabilities dc, AndroidDriver<AndroidElement> driver, WebDriverWait wait) throws IOException {
		...
		MobileElement el3 = (MobileElement) driver.findElementByXPath("//android.widget.TextView[@content-desc=\"Worried About Getting COVID\"]");
		el3.click();
		...
		MobileElement el5 = (MobileElement) driver.findElementByAccessibilityId("Myself");
		el5.click();
		
		driver.manage().timeouts().implicitlyWait(10, TimeUnit.SECONDS);

		MobileElement el6 = (MobileElement) driver.findElementByAccessibilityId("Not really");
		el6.click();
		...
		el7.sendKeys("Do you remember my purchases for covid anxiety relief?");
...
//		wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("/hierarchy/android.widget.FrameLayout/android.widget.LinearLayout/android.widget.FrameLayout/android.widget.FrameLayout/android.widget.FrameLayout/android.widget.LinearLayout/android.widget.FrameLayout/android.widget.LinearLayout/android.widget.RelativeLayout/androidx.recyclerview.widget.RecyclerView/android.widget.LinearLayout[5]/android.widget.FrameLayout/android.widget.RelativeLayout/android.widget.FrameLayout/android.widget.LinearLayout/android.widget.TextView\n")));
//
...
//		driver.manage().timeouts().implicitlyWait(10, TimeUnit.SECONDS);
		...
		FileUtils.writeByteArrayToFile(new File("1.12 Test.mp4"), decode);
