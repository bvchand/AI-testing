...
public class Wysa_TC2_10 {
	static void tc210(DesiredCapabilities dc, AndroidDriver<AndroidElement> driver, WebDriverWait wait) throws IOException {
		...
		el5.sendKeys("Self-awareness i’m how");
		driver.manage().timeouts().implicitlyWait(50, TimeUnit.SECONDS);
		...
		MobileElement el7 = (MobileElement) driver.findElementByAccessibilityId("Yes!");
		el7.click();
		driver.manage().timeouts().implicitlyWait(50, TimeUnit.SECONDS);
		...
		el9.sendKeys("Suggest any exercises");
		driver.manage().timeouts().implicitlyWait(50, TimeUnit.SECONDS);
		...
		el10a.click();
		driver.manage().timeouts().implicitlyWait(50, TimeUnit.SECONDS);
		MobileElement el11 = (MobileElement) driver.findElementByAccessibilityId("Something Else");
		el11.click();
		driver.manage().timeouts().implicitlyWait(10, TimeUnit.SECONDS);
		...
		FileUtils.copyFile(scrFile2, new File("2.10." + ".jpg"));
		System.out.println("Screenshot taken and saved to folder.");
		String video = driver.stopRecordingScreen();

        byte[] decode = Base64.getDecoder().decode(video);

        FileUtils.writeByteArrayToFile(new File("2.10.mp4"), decode);
