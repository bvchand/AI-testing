...
public class Wysa_TC1_8 {
	static void tc1_8(DesiredCapabilities dc, AndroidDriver<AndroidElement> driver, WebDriverWait wait) throws IOException {
		...
		FileUtils.writeByteArrayToFile(new File("1.8 Test.mp4"), decode);
