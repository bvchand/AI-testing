...
public class Wysa_TC1_4 {
	static void tc1_4(DesiredCapabilities dc, AndroidDriver<AndroidElement> driver, WebDriverWait wait) throws IOException {
...
MobileElement el1 = (MobileElement) driver.findElementByAccessibilityId("Wysa");
		...
		el7.sendKeys("Do you remember why i felt weak?");
		...
		el11.sendKeys("what we spoke last");
		...
		FileUtils.writeByteArrayToFile(new File("1.4 Test.mp4"), decode);
