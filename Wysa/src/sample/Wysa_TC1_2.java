...
public class Wysa_TC1_2 {
	static void tc2(DesiredCapabilities dc, AndroidDriver<AndroidElement> driver, WebDriverWait wait) throws IOException {
...
MobileElement el1 = (MobileElement) driver.findElementByAccessibilityId("Wysa");
		...
		el7.sendKeys("anxious I'm feeling");
		...
		el11.sendKeys("anxious I'm feeling");
		...
		wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("//android.widget.TextView[@content-desc=\"Take me there 🧘\"]")));
		...
		MobileElement el16 = (MobileElement) driver.findElementById("bot.touchkin:id/play_pause");
		el16.click();
