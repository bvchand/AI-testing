...
public class Wysa_TC1_11 {
	static void tc11(DesiredCapabilities dc, AndroidDriver<AndroidElement> driver, WebDriverWait wait) throws IOException {
...
//		driver.manage().timeouts().implicitlyWait(10, TimeUnit.SECONDS);
		...
		FileUtils.writeByteArrayToFile(new File("1.11 Test.mp4"), decode);
